...
<body>
    <header>
        ...
        <form class="search" action="post">
            ...
            <button type="submit"><img class="search-icon" src="Assets/icon/search.svg" width="20px"></button>
        </form>
        <div class="profil">
            <button id="profil-btn"><img class="profil-img" src="Assets/icon/profil.svg" alt=""></button>
        </div>
    </header>
        ...
        <div class="data-menu">
            <div class="belum-dikerjakan" id="belum-dikerjakan">
                <div class="header-list">
                    ...
                    <a class="print-btn" href="printuncomplete.php" target="_blank"><img src="assets/icon/print.svg"
            ...
            <div class="sudah-dikerjakan" id="sudah-dikerjakan">
                <div class="header-list">
                    ...
                    <a class="print-btn" href="printcomplete.php" target="_blank"><img src="assets/icon/print.svg"
                            width="30px" alt="print"></a>
                </div>
